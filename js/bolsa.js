...
//     // Obtener el contenedor donde se mostrarán los productos en la bolsa
//     const contenedorBolsa = document.querySelector(".productosBolsa");

//     // Obtener el elemento para mostrar el total
//     const totalElement = document.getElementById("total");

//     // Obtener la bolsa del almacenamiento local o inicializarla si no existe
//     const bolsa = JSON.parse(localStorage.getItem('bolsa')) || [];

//     // Si la bolsa está vacía, mostrar mensaje de bolsa vacía
//     if (bolsa.length === 0) {
//         const bolsaVaciaElement = document.querySelector(".bolsaVacia");
//         bolsaVaciaElement.style.display = "block";
//     } else {
//         // Calcular el total y mostrar los productos en la bolsa
//         let total = 0;
//         bolsa.forEach(producto => {
//             total += producto.precio * producto.cantidad;
//             const productoBolsaElement = crearElementoProductoBolsa(producto);
//             contenedorBolsa.appendChild(productoBolsaElement);
//         });
...
// // Función para crear el elemento de un producto en la bolsa
// function crearElementoProductoBolsa(producto) {
//     const divProducto = document.createElement("div");
//     divProducto.classList.add("productoBolsa");

//     divProducto.innerHTML = `
//         <img class="imgBolsa" src="${producto.imagen}" alt="">
...
//             <small>Precio</small>
//             <p>${producto.precio} S/.</p>
//         </div>
//         <div class="subtotalBolsa">
//             <small>Subtotal</small>
//             <p>${producto.precio * producto.cantidad} S/.</p>
//         </div>
//         <button class="borrar" data-id="${producto.id}"><i class="bi bi-trash-fill"></i></button>
//     `;

//     // Agregar evento click para el botón "borrar"
//     const btnBorrar = divProducto.querySelector(".borrar");
//     btnBorrar.addEventListener("click", () => {
//         borrarProductoDeBolsa(producto.id);
//     });
...
// function borrarProductoDeBolsa(idProducto) {
//     // Obtener la bolsa actual del almacenamiento local
//     const bolsa = JSON.parse(localStorage.getItem('bolsa')) || [];

//     // Filtrar la bolsa para eliminar el producto con el id especificado
//     const bolsaNueva = bolsa.filter(producto => producto.id !== idProducto);

//     // Guardar la nueva bolsa en el almacenamiento local
//     localStorage.setItem('bolsa', JSON.stringify(bolsaNueva));

//     // Recargar la página para actualizar la lista de productos en la bolsa
//     location.reload();
// }
...
// // Llamamos a la función para cargar los productos en la bolsa al cargar la página
// document.addEventListener('DOMContentLoaded', () => {
