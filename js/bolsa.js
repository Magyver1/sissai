...
function cargarProductosEnBolsa() {
    ...
    // Agregar evento click al botón "Vaciar Bolsa"
    const btnVaciar = document.querySelector('.btnVaciar');
    btnVaciar.addEventListener('click', vaciarBolsa);
}
...
// Obtener el botón de "Hacer compra"
const btnHacerCompra = document.getElementById("btnHacerCompra");

// Agregar el evento click al botón de "Hacer compra"
btnHacerCompra.addEventListener("click", () => {
    // Mostrar SweetAlert de agradecimiento por la compra
    Swal.fire({
        icon: 'success',
        ...
        // Si el usuario hace clic en el botón "Aceptar" del SweetAlert, vaciar la bolsa
