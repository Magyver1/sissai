...
//         bolsa.push({ id, nombre, precio, cantidad: 1 });
//     }
...
//     // Obtener el elemento del número de la bolsa en index.html
//     const numeroBolsaIndex = document.querySelector('.numero');

//     // Obtener el elemento del número de la bolsa en bolsa.html
//     const numeroBolsaBolsa = document.querySelector('.numero-bolsa');

//     // Calcular el total de productos en la bolsa
//     const totalProductos = bolsa.reduce((total, producto) => total + producto.cantidad, 0);

//     // Actualizar el número de la bolsa en ambos botones
//     numeroBolsaIndex.textContent = totalProductos;
